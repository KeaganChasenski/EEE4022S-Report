...
\par\noindent\makebox[2.5in]{\includegraphics[width=0.3\linewidth]{FrontMatter/Signature.png}}
\hfill\makebox[2.0in]{\today}

\par\noindent\makebox[2.5in]{\hrulefill} \hfill\makebox[2.0in]{\hrulefill}%
\par\noindent\makebox[2.5in][l]{Keagan Chasenski}      \hfill\makebox[2.0in][l]{Date}%

\vspace{1.5cm}
\textbf{Report word count: 17 439 }
}